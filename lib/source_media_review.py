...
def _probe_video(path: Path, tool_registry: Any) -> dict[str, Any]:
    ...
    # If audio_probe didn't work, or it succeeded but lacks video-specific fields
    # (audio_probe is audio-centric and never returns "resolution"), fall back to ffprobe.
