...
- **Optional cloud render offload** — rent a short-lived Vast.ai CPU box for renders that would take too long locally, with hard cost ceilings, an explicit human approval per rental, and guaranteed automatic teardown. Disabled by default; see `docs/cloud-render.md`.
